...
```
##          date recorded_number_of_steps_taken
## 1  2012-10-01                              0
## 2  2012-10-02                            126
## 3  2012-10-03                          11352
## 4  2012-10-04                          12116
...
```
##     interval average_number_of_steps_taken
## 1          0                     1.7169811
## 2          5                     0.3396226
## 3         10                     0.1320755
## 4         15                     0.1509434
...
The five-minute interval that contains the maximum number of steps across all days, on average, is 835, which is 13:55.
...
There are 2304 cases with missing values in the dataset.  We will use the mean for the 5-minute interval to fill in the NAs.
...
The mean total number of steps taken per day is 1.0766189 &times; 10<sup>4</sup> and the median total number of steps taken per day is 1.0766189 &times; 10<sup>4</sup>, which is a difference of 1411.959171 and 371.1886792 for the respective values, computed without imputing new values for the NAs (having removed them previously). 
...
```
## Warning in if (NewActivity$weekday %in% c("Saturday", "Sunday")) {: the
